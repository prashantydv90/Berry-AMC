      ...
      <div className="hidden md:flex md:w-1/4 md:justify-end  items-center gap-4">
        {!user ? (
          ...
          <div className="relative group">
            <div
              className="w-10 h-10 text-xl rounded-full bg-blue-600 text-white flex items-center justify-center font-semibold cursor-pointer"
              title={user.name}
            >
            ...
            {/* Dropdown on hover */}
            <div className="absolute right-0 mt-2 w-46 bg-white rounded-lg shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              {/* <button
