...
//     <NavBar />
//     {loading ? <p className="pt-28 min-h-screen flex justify-center text-2xl font-medium">Loading clients...</p> :
//       <div className="min-h-screen pt-18 sm:pt-20 bg-zinc-100 flex-1 overflow-y-auto">
...
//             <div className="px-4 py-2 rounded-md text-[14px] font-medium bg-blue-600 text-white hover:bg-blue-700 cursor-pointer text-center"
...
//         {/* Table Header + Rows */}
//         <div className="mt-3 mx-4 md:mx-20 overflow-x-auto">
//           {/* Table Header */}
//           <div className="min-w-[800px] flex bg-blue-700 py-2 rounded-md px-4 text-white shadow-md text-sm gap-x-4">
//             <div className="flex items-center gap-1 min-w-[100px] w-[15%]"><IdCardLanyard size={16} />PAN No.</div>
//             <div className="flex items-center gap-1 min-w-[150px] w-[25%]"><User size={16} />Client Name</div>
//             <div className="flex items-center gap-1 min-w-[120px] w-[15%]"><Wallet size={16} />Total Value</div>
//             <div className="flex items-center gap-1 min-w-[120px] w-[15%]"><Clock size={16} className="mt-0.5" />Last Updated</div>
//             <div className="min-w-[150px] text-center w-[30%]">Actions</div>
//           </div>

//           {/* Table Rows */}
//           {clients?.map((client, idx) => (
//             <div key={idx} className="min-w-[800px] flex py-3.5 rounded-md px-4 font-medium items-center bg-white shadow-md mt-3 gap-x-4">
...
//   {toIndianFormat(((Number(client?.FDTotalValue) || 0) + (Number(client?.MFTotalValue) || 0)).toFixed(0)) || 'NA'}
// </div>
//               <div className="min-w-[120px] w-[15%]">{formatDate(client.updatedAt)}</div>
//               <div className="min-w-[150px] w-[30%] flex justify-center gap-3">
//                 <div className="px-4 py-1.5 text-[14px] rounded-md bg-green-600 hover:bg-green-700 cursor-pointer text-white"
