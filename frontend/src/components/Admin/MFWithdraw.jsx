...
export const MFWithdraw = ({ setWithdrawForm, client }) => {
  ...
  //     await axios.post(
  //       "https://berry-amc.onrender.com/api/addinvestment/mf", // or mftransaction
  //       {
  //         clientId: client._id,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (withdrawalAmount === totalValue) {
        const url = `https://berry-amc.onrender.com/api/resetInvestment/mf/${client._id}`;
      ...
      // 🟢 PARTIAL WITHDRAW → LEDGER ENTRY
        ...
        await axios.post(
          "https://berry-amc.onrender.com/api/addinvestment/mf",
          {
            clientId: client._id,
